    ...
    <div className="relative min-h-screen w-full bg-background text-foreground z-20">
      ...
      <section className="max-w-4xl mx-auto px-6 py-32 flex flex-col gap-12">
        <div className="flex justify-between items-center border-b border-gray-800 pb-10">
          ...
          <Link href="/" className="text-accent hover:text-white uppercase tracking-widest text-sm transition-colors magnetic inline-block border border-accent/20 px-6 py-3 rounded-full hover:bg-accent/10">
            Close Case Study ✕
          </Link>
        </div>
        
        <p className="text-xl md:text-2xl font-serif text-gray-400 leading-relaxed italic">
          This is a placeholder case study page. In a full production environment, this page would contain detailed insights into the design process, early wireframes, typography choices, and the final high-fidelity results for {project.title}.
        </p>
